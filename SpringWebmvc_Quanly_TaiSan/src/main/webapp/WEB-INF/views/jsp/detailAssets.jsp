...
<link rel="stylesheet" type="text/css"
	href="resoures/css/bootstrap.min.css">
</head>
<body>
	<!DOCTYPE html>
<html lang="en">
...
<body class="">
						...
						<ul class="pcoded-submenu">
							...
							<li><a href="listAssets" target="_blank">Tai san</a></li>
							 <li><a href="listHandover" target="_blank">Phiếu Bàn Giao</a></li>
                               <li><a href="listAssets" target="_blank">Phiếu Mượn</a></li>
						</ul></li>
	...
	<div class="pcoded-main-container">
		<div class="pcoded-content">
			...
			<div class="container" style="background: #9cdfd2;">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<table class="table table-bordered">
								...
								<tr>
									<td style="font-size: 25px">Mã tài Sản:</td>
									<td style="font-size: 25px; color: black;">${a.asetId }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Tên Tài Sản:</td>
									<td style="font-size: 25px; color: black;">${a.asetName }</td>

								</tr>

								<tr>
									<td style="font-size: 25px">SỐ SERI:</td>
									<td style="font-size: 25px; color: black;">${a.serialNumber }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">NGÀY MƯỢN-TRẢ:</td>
									<td style="font-size: 25px; color: black;">${a.purchaseDate }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">TRẠNG THÁI:</td>
									<td style="font-size: 25px; color: black;">${a.condition?"mua":"tra" }</td>
								...
								<tr>
									<td style="font-size: 25px">CHI PHí:</td>
									<td style="font-size: 25px; color: black;">
									<fmt:formatNumber>${a.purchaseCost}</fmt:formatNumber>
						...
						<div class="col-md-6">
							<table>
								...
								<tr>
									<td style="font-size: 25px">ẢNH:</td>
									<td><img width="300px"
										src="<c:url value="resoures" />/images/${a.image}" /></td>
				...
				<button>
					<a style="font-size: 25px" href="listAssets">back</a>

				</button>
				<button>
					<a style="font-size: 25px"
						href="initUpdateAssets?asetId=${a.asetId }">update</a>
				</button>
