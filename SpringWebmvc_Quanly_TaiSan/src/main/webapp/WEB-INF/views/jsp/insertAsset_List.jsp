			...
			<div class="card">
				...
				<div class="card-body">
					...
					<hr>
						...
						<form:form action="insertAsset_List" modelAttribute="a" method="post"
							enctype="multipart/form-data">
	<div class="row">
							<div class="col-md-6">
							<div class="form-group">
									<label for="exampleInputEmail1">Asset_ListName</label> <input
										type="text" class="form-control" id="assetName"
										name="assetName" placeholder="Enter assetName">
								</div>
