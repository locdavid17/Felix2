		...
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form:form action="UpdateAssets" modelAttribute="a" method="post"
						enctype="multipart/form-data">
						<div class="row">
							<div class="col-md-6">
							<div class="form-group">
									<label >Mã Tài Sản:</label>
									<form:input path="asetId" readonly="true" />
								</div>
								<div class="form-group">
									<label >Tên tài Sản:</label>
									<form:input path="asetName" type="text"/>
								</div>
								<div class="form-group">
									<label for="exampleInputEmail1">SerialNumber</label>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<form:input path="purchaseCost" />
								</div>

								<div class="form-group">
									<label>Condition:</label>
									<input type="radio" name="condition" value="true" ${a.condition?"checked":"" }>mua
				                    <input type="radio" name="condition" value="false" ${!a.condition?"checked":"" }>tra
								</div>
								<div class="form-group">
