...
<body class="">
    ...
    <div class="pcoded-main-container">
        <div class="pcoded-content">
			...
			<div >
			<button class="btn btn-success" style="margin-left: 50px;margin-bottom: 5px" >
					<a href="initHandover" style="color: white;">Mượn
						Tài Sản</a>
			</button>
			
			</div>
     <div style="margin-left: 1000px;margin-top: -50px">
     	<button class="btn btn-success"><a href="initAssets" style="color: white;">Thêm Mới Tài Sản</a></button>
     
     </div>
	<div class="container" style="background: #9cdfd2;">
	<form action="searchAssetsName">
		<b style="color:maroon; ">Assets Name:</b>
		<input type="text" name="asetName" /> 
			...
			<thead>
				...
				<tbody>
					...
					<tr>
					    <th>${a.asetId }</th>
					    <th>${a.asetName }</th>
						<th>${a.serialNumber }</th>
						<th><img width="100px" src="<c:url value="resoures" />/images/${a.image}"/></th>
						<th>
							<fmt:formatDate value="${a.purchaseDate }"/>
						</th>
						<th>
							<fmt:formatNumber value="${a.purchaseCost }"></fmt:formatNumber>
						</th>
						<th>${a.condition? "bàn giao":"trả" }</th>
						<th>${a.asetList.assetName }</th>
						<th><button class="btn btn-success"><a href="detailAssets?asetId=${a.asetId }" style="color: black">Detail</a></button></th>
						<th>
							<button class="btn btn-danger"><a href="deleteAssets?asetId=${a.asetId }" onclick="return confirm('ban co chac muon xoa khong')" ">Delete</a></button>
						</th>
				...
				<c:forEach items="${listpage }" var="page">
					<a class="btn btn-danger" href="listAssets?page=${page }" style="color: black;">${page }</a>
