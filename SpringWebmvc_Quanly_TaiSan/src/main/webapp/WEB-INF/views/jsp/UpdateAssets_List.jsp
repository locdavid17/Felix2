		...
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form:form action="UpdateAssets_List" modelAttribute="a" method="post"
						...
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="form-group">
									<label for="exampleInputEmail1">AssetName</label>
									<form:input path="assetName" />
								</div>
								<div class="form-group">
									<label>Image</label> <input type="file" class="form-control"
										name="imgUrl" /><img width="100px" src="<c:url value="resoures" />/images/${a.image}"/>
								</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>Status:</label>
									<input type="radio" name="status" value="true" ${a.status?"checked":"" }>Tốt
				                    <input type="radio" name="status" value="false" ${!a.status?"checked":"" }>Chưa Tốt
								</div>
								<div class="form-group">
								
									<label>Department</label>
									<form:select path="depart.DepartmentID">
										<form:options items="${listDepartment }" itemLabel="departmentName"
								...
								<div class="form-group">
									...
									<label>Department</label>
									<form:select path="location.locationID">
										<form:options items="${listLocation }" itemLabel="locationName"
