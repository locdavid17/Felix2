...
<body class="">
    ...
    <div class="pcoded-main-container">
      ...
      <div style="margin-left: 1000px;margin-top: -50px">
     	<button class="btn btn-success"><a href="initAsset_List" style="color: white;">Thêm Mới Danh Mục</a></button>
     
     </div>
           
	<div class="container" style="background: #9cdfd2;">
	<form action="searchAssets_ListName">
		<b style="color:maroon; ">Assets Name:</b>
		<input type="text" name="assetName" /> 
		<input type="submit" value="search" />
	
	</form>
	<h1>List Asset_List</h1>
	<table class="table table-borderred" >
			<thead>
				...
				<tbody>
					...
					<tr>
						...
						<th>${a.description }</th>
						<th>${a.quantity }</th>
						<th >${a.status?"Tốt":"Chưa Tốt" }</th>
						<th>${a.depart.departmentName }</th>
						<th>${a.location.locationName }</th>
						<th><button class="btn btn-success"><a href="DetailAssets_List?assetID=${a.assetID }" style="color: black">Detail</a></button></th>
						<th>
							<button class="btn btn-danger"><a href="deleteAssets_List?assetID=${a.assetID }" onclick="return confirm('ban co chac muon xoa khong')" ">Xóa</a></button>
						</th>
			...
			<c:forEach items="${listpage }" var="page">
					<a class="btn btn-danger" href="listAsset_List?page=${page }" style="color: black;">${page }</a>
