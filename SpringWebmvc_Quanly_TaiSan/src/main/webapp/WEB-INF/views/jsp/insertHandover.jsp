				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu"><a href="#!"
						...
						<ul class="pcoded-submenu">
							...
							<li><a href="listHandover" target="_blank">Phiếu Bàn
									Giao</a></li>
					...
					<li class="nav-item pcoded-hasmenu"><a href="#!"
						class="nav-link "><span class="pcoded-micon"><i
								...
								Phòng Ban </span></a>
						<ul class="pcoded-submenu">
							<li><a href="listDepartment" target="_blank">Danh sách
									Phòng Ban</a></li>
					...
					<li class="nav-item pcoded-hasmenu"><a href="#!"
						class="nav-link "><span class="pcoded-micon"><i
								...
								Chức Năng </span></a>
						<ul class="pcoded-submenu">
							<li><a href="initAssets" target="_blank">them moi Tai
									san</a></li>
							<li><a href="initAsset_List" target="_blank">Thêm mới
									Danh Mục Tài Sản</a></li>
							<li><a href="initInsertDepartment" target="_blank">Thêm
									mới Phong Ban</a></li>
						</ul></li>
		...
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form:form action="insertHandover" modelAttribute="h" method="post">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for=""> Ma phieu Muon</label> <input type="text"
										class="form-control" id="handoverID" name="handoverID"
										placeholder="Enter handoverID">
									<%-- 	<br>
									<form:errors path="asetName" cssClass="err"></form:errors> --%>
								</div>
								<div class="form-group">
									<label for=""> Người Mượn</label> <input type="text"
								...
								<div class="form-group">
									<label for="">Ngay Muon</label> <input type="date"
							...
							<div class="col-md-6">
								<div class="form-group">
									<label>Ngay tra</label> <input type="date" class="form-control"
										name="returnedDate" />
								</div>
								...
								<div class="form-group">
									<label>AssetID</label>
									<form:select path="asset_List.assetID">
							...
							<div class="form-group">
								<label>Tai San</label>
								<form:select path="assets.asetId">
									<form:options items="${listAssets }" itemLabel="asetName"
										itemValue="asetId" />
								</form:select>
								<br>
