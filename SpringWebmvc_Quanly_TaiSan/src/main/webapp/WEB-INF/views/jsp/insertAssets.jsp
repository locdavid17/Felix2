				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item pcoded-hasmenu"><a href="#!"
						class="nav-link "><span class="pcoded-micon"><i
								...
								Quản lý Thong Tin Tai San </span></a>
						<ul class="pcoded-submenu">
							<li><a href="listAsset_List" target="_blank">Danh muc
									Tai san</a></li>
							<li><a href="listAssets" target="_blank">Tai san</a></li>
							 <li><a href="listHandover" target="_blank">Phiếu Bàn Giao</a></li>
                               <li><a href="" target="_blank">Phiếu Mượn</a></li>
						</ul></li>
	...
	<header
		...
		<div class="m-header">
			...
			<a href="#!" class="b-brand"> <!-- ========   change your logo hear   ============ -->
				<img src="resoures/images/logo.png" alt="" class="logo"> <img
				src="resoures/images/logo-icon.png" alt="" class="logo-thumb">
						...
						<div class="dropdown-menu dropdown-menu-right notification">
							...
							<ul class="noti-body">
								...
								<li class="notification">
									<div class="media">
										<img class="img-radius"
											src="resoures/images/user/avatar-1.jpg"
								...
								<li class="notification">
									<div class="media">
										<img class="img-radius"
											src="resoures/images/user/avatar-2.jpg"
											alt="Generic placeholder image">
										<div class="media-body">
											<p>
				...
				<li>
					<div class="dropdown drp-user">
						...
						<div
							...
							<div class="pro-head">
								<img src="resoures/images/user/avatar-1.jpg" class="img-radius"
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<hr>
						...
						<form:form action="insertAssets" modelAttribute="a" method="post"
							enctype="multipart/form-data">
	<div class="row">
							<div class="col-md-6">
							<div class="form-group">
									<label for="">asetName</label> <input
										type="text" class="form-control" id="asetName"
										name="asetName" placeholder="Enter asetName">
									<%-- 	<br>
									<form:errors path="asetName" cssClass="err"></form:errors> --%>
								</div>
								
								<div class="form-group">
									<label for="">SerialNumber</label> <input
										type="text" class="form-control" id="serialNumber"
										name="serialNumber" placeholder="Enter SerialNumber">
										<%-- <br>
										<form:errors path="serialNumber" cssClass="err"></form:errors> --%>
								</div>
								<div class="form-group">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="">PurchaseDate</label> <input
										type="date" class="form-control" id="serialNumber"
										name="purchaseDate" placeholder="Enter PurchaseDate">
										<%-- <br>
										<form:errors path="purchaseDate" cssClass="err"></form:errors> --%>
								</div>
								<div class="form-group">
									<label>PurchaseCost</label> <input type="text"
										class="form-control" name="purchaseCost"">
										<%-- <br>
									<form:errors path="purchaseCost" cssClass="err"></form:errors> --%>
								</div>

								<div class="form-group">
									<label>Condition:</label>
									<form:radiobutton path="condition" value="true"/>
									mua
									<form:radiobutton path="condition" value="false" />
									trả
									<%-- <br>
								<form:errors path="condition" cssClass="err"></form:errors> --%>
								</div>
								<div class="form-group">
									<label>AssetID</label>
									<form:select path="asetList.assetID">
										<form:options items="${listAset }" itemLabel="assetName"
											itemValue="assetID" />
									</form:select>
								<br>
