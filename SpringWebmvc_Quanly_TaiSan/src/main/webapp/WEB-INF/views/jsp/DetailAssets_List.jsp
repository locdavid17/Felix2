	...
	<div class="pcoded-main-container">
		<div class="pcoded-content">
			...
			<div class="container" style="background: #9cdfd2;">
				...
				<div class="container">
					<h1>Detail Asset_List</h1>
					<div class="row">
						<div class="col-md-6">

							<table class="table table-bordered">
								<tr>
									<td style="font-size: 25px">AssetID:</td>
									<td style="font-size: 25px; color: black;">${a.assetID }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">AssetName:</td>
									<td style="font-size: 25px; color: black;">${a.assetName }</td>

								</tr>

								<tr>
									<td style="font-size: 25px">Quantity:</td>
									<td style="font-size: 25px; color: black;">${a.quantity }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">DepartmentId:</td>
									<td style="font-size: 25px; color: black;">${a.depart.departmentName }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">LocationId:</td>
									<td style="font-size: 25px; color: black;">${a.location.locationName }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Description:</td>
									<td style="font-size: 25px; color: black;">${a.description }</td>
				...
				<button>
					<a style="font-size: 25px" href="listAsset_List">back</a>
				</button>
				<button>
					<a style="font-size: 25px"
						href="initUpdateAsset_List?assetID=${a.assetID }">update</a>
				</button>
			</div>
