					...
					<form:form action="UpdateDepartment" modelAttribute="d" method="post"
						...
						<div class="row">
							...
							<div class="form-group">
									...
									<form:input path="departmentID" readonly="true" />
								</div>
								...
								<div class="form-group">
									<label>manager</label> <form:input type="text" 
										path="manager" />
								</div>
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>status:</label>
									<input type="radio" name="status" value="true" ${d.status?"checked":"" }>Đang Hoạt Động
				                    <input type="radio" name="status" value="false" ${!d.status?"checked":"" }>Chưa Hoạt Động
								</div>
