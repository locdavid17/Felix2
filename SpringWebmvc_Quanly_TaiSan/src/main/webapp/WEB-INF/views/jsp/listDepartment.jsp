...
<body class="">
    ...
    <div class="pcoded-main-container">
     ...
     <div style="margin-left: 1000px">
     	<button class="btn btn-success"><a href="initInsertDepartment" style="color: white;">Thêm Mới Phòng ban</a></button>
	...
	<table class="table table-borderred" >
			<thead>
				...
				<tbody>
					...
					<tr>
					    <th>${d.departmentID }</th>
					    <th>${d.departmentName }</th>
						<th>${d.manager }</th>
						<th>${d.address }</th>
						<th>${d.status?"Đang Hoạt Động":"Chưa Hoạt Động" }</th>
					
						<th><button class="btn btn-success"><a href="detailDepartment?departmentID=${d.departmentID }" style="color: black">Detail</a></button></th>
						<th>
							<button class="btn btn-danger"><a href="deleteDepartment?departmentID=${d.departmentID }" onclick="return confirm('ban co chac muon xoa khong')" ">Delete</a></button>
						</th>
