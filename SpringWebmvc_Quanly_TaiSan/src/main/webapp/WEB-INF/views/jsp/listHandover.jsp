	...
	<div class="pcoded-main-container">
		<div class="pcoded-content">
			...
			<div style="margin-left: 940px">
				<span >
					<a class="btn btn-success" href="initHandover" style="color: white;">Mượn Tài Sản</a>
					<a class="btn btn-danger" href="initPay_Slip" style="color: white;">Trả Tài Sản</a>
				</span>
				...
				<table class="table table-borderred">
					...
					<tbody>
						...
						<c:forEach items="${list }" var="h">
							<tr>
								<th>${h.handoverID }</th>
								<th>${h.asset_List.assetName }</th>
								<th>${h.borrower }</th>
								<th>${h.assets.asetName }</th>
								<th><fmt:formatDate value="${h.paymentDate }"
										pattern="dd/MM/yyyy" /></th>
								<th><fmt:formatDate value="${h.returnedDate }"
										pattern="dd/MM/yyyy" /></th>

								<th><button class="btn btn-success">
										<a href="detailHandover?handoverID=${h.handoverID }"
											style="color: black">Detail</a>
									</button></th>
								<th>
									<button class="btn btn-danger">
										<a href="deleteHandover?handoverID=${h.handoverID }"
