	...
	<div class="pcoded-main-container">
		<div class="pcoded-content">
			...
			<div class="container" style="background: #9cdfd2;">
					...
					<div class="row">
						<div class="col-md-6">
							...
							<table class="table table-bordered">
								...
								<tr>
									<td style="font-size: 25px">Mã Phiếu Mượn:</td>
									<td style="font-size: 25px; color: black;">${h.handoverID }</td>

								</tr>

								<tr>
									<td style="font-size: 25px">Tên Danh Mục:</td>
									<td style="font-size: 25px; color: black;">${h.asset_List.assetName }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Nguời Mượn:</td>
									<td style="font-size: 25px; color: black;">${h.borrower }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Tên Tài Sản:</td>
									<td style="font-size: 25px; color: black;">${h.assets.asetName }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Ngày Mượn:</td>
									<td style="font-size: 25px; color: black;">${h.paymentDate}</td>

								</tr>
								</tr>
								<tr>
									<td style="font-size: 25px">Ngày Trả:</td>
									<td style="font-size: 25px; color: black;">${h.returnedDate}</td>
				...
				<button>
					<a style="font-size: 25px" href="listHandover">back</a>

				</button>
				<%-- <button>
					<a style="font-size: 25px"
						href="initUpdateDepartment?departmentID=${d.departmentID }">update</a>
				</button> --%>
