	...
	<div class="pcoded-main-container">
		<div class="pcoded-content">
			...
			<div class="container" style="background: #9cdfd2;">
						...
						<div class="col-md-6">
							...
							<table class="table table-bordered">
								...
								<tr>
									...
									<td style="font-size: 25px; color: black;">${d.departmentID }</td>

								</tr>

								<tr>
									<td style="font-size: 25px">DepartmentName:</td>
									<td style="font-size: 25px; color: black;">${d.departmentName }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Manager:</td>
									<td style="font-size: 25px; color: black;">${d.manager }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Address:</td>
									<td style="font-size: 25px; color: black;">${d.address }</td>

								</tr>
								<tr>
									<td style="font-size: 25px">Status:</td>
									<td style="font-size: 25px; color: black;">${a.status?"Đang Hoạt Động":"Chưa Hoạt Động"}</td>
				...
				<button>
					<a style="font-size: 25px" href="listDepartment">back</a>
