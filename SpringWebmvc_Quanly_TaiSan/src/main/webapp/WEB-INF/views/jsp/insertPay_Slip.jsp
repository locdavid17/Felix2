		...
		<div class="col-sm-12">
			<div class="card">
				...
				<div class="card-body">
					...
					<form:form action="insertPay_Slip" modelAttribute="p" method="post">
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									<label for=""> Ma phieu Trả</label> <input type="text"
										class="form-control" id="pay_Slip_Id" name="pay_Slip_Id"
										placeholder="Enter pay_Slip_Id">
									<%-- 	<br>
									<form:errors path="asetName" cssClass="err"></form:errors> --%>
								</div>
								<div class="form-group">
									<label for=""> Người Trả</label> <input type="text"
								...
								<div class="form-group">
									<label for="">Ngay Trả</label> <input type="date"
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<label>AssetID</label>
									<form:select path="asset_Lists.assetID">
										<form:options items="${listAsset_List }" itemLabel="assetName"
											itemValue="assetID" />
									</form:select>
									<br>
